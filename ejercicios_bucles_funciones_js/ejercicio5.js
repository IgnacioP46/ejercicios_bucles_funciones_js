...
const albums = [
  ...
  for (let i = 0; i < albums.length; i++) {
    if (albums[i].genre === 'Rock') {//sacamos todos los valores dentro de genero que sean identicos a rock
      totalRockDuration += albums[i].duration;//sumamos todos los minutos y se los asignamos a la variable totalRockDuration
    }
  }
  
  console.log(`La duración total de los álbumes de rock es: ${totalRockDuration} minutos`);//La duración total de los álbumes de rock es: 430.55 minutos